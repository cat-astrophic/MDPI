...
def main(rep):
    ...
    data = pd.read_csv('C:/Users/User/Documents/Data/MDPI/Frascati_' + str(rep) + '.csv')
    ...
    pd.DataFrame(M, columns = reftab).to_csv('C:/Users/User/Documents/Data/MDPI/FM_M_' + str(rep) + '.csv', index = False)
    pd.DataFrame(Collaborators).to_csv('C:/Users/User/Documents/Data/MDPI/FM_Collaborators_' + str(rep) + '.csv', index = False)

# Using the main function to get overall and annual results

repetitions = ['all', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006',
